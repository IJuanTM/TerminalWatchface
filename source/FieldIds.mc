...
const FIELD_LACTATE_HR = 12;
const FIELD_TRAINING_STATUS = 13;
const FIELD_WRIST_TEMP = 14;
const FIELD_HR_RESTING = 15;
const FIELD_HR_RESTING_AVG = 16;
const FIELD_HR_RESTING_BOTH = 17;
const FIELD_HR_SPO2 = 18;
const FIELD_RESP_SPO2 = 19;
const FIELD_BODY_BAT_STRESS = 20;
const FIELD_BODY_BAT_RECOVERY = 21;
const FIELD_STRESS_RECOVERY = 22;
const FIELD_VO2_TRAINING = 23;
const FIELD_BODY_BAT_REST_HR = 24;
const FIELD_SLEEP_RECOVERY = 25;
...
const FIELD_WX_TEMP_WIND = 452;
const FIELD_WX_TEMP_UV = 453;
const FIELD_WX_TEMP_HUMIDITY = 454;
const FIELD_WX_TEMP_PRECIP = 455;
const FIELD_WX_TEMP_HIGH_LOW = 456;
const FIELD_WX_COND_PRECIP = 457;
const FIELD_WX_WIND_PRECIP = 458;
const FIELD_WX_UV_WIND = 459;
const FIELD_WX_UV_PRECIP = 460;
const FIELD_WX_HUMIDITY_PRECIP = 461;
const FIELD_WX_HUMIDITY_DEW = 462;
const FIELD_WX_CLOUD_PRECIP = 463;
...
const FIELD_WX_FCST_HUMIDITY = 506;
const FIELD_WX_FCST_CLOUD = 507;
